...
export default function SBLaunchSite(props: any) {
  ...
  return <>
    ...
    <Chopstick root={scene} prefix="PAD2" config={props.config} chopstickHeights={[24, 28.1, 52.16, 62.3+2.3, 107.39+2.3]} zeroRotationOffset={10.5} maxAngle={75.3} onVehicleMarker={(marker) => setChopstickVehicleMarkers(prev => ({ ...prev, "PAD2": marker }))} />
