...
export const locationPresets: LocationPresets = {
  "0403e1dc-fe0e-401d-835e-092bbfde8772": {
    ...
    "megabay 1": {
      "bay 1": { x: -234.277, y: 8.5885, z: 99.5445, r: 135 },
      "bay 2": { x: -234.277, y: 8.5885, z: 83.7945, r: 90 },
      "bay 3": { x: -234.277, y: 8.5885, z: 68.0445, r: 45 },
  ...
  "da41c0c8-7a89-4962-b190-ab0d8a634659": {
    "pad 2": {
      "Stacking Station": { x: -196.116, y: 0, z: 46.5511090875113, r: 90-4+180 },
      "OLM": { x: -208.761, y: 12.4417, z: 62.4059, r: 190 },
      "OLM Ship": { x: -208.761, y: 10.1417+68.8029+2.3, z: 62.4059, r: 10 },
    },
    "pad 1": {
